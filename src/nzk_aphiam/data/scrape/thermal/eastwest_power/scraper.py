...
DEFAULT_RETRIES = 3
FUEL_MAPPING_REFERENCE = "docs/references/thermal/eastwest_power_fuel_type_mapping.csv"
ENRICHMENT_SOURCES = [
    {
...
DEFAULT_OUTPUT_DIR = PROJECT_ROOT / "data" / "raw" / "kepco_subsidiaries" / "eastwest_power"
