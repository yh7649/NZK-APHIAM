"""
Scrape Korea Western Power monthly air-pollutant emissions and generation data.

Source:
    https://www.data.go.kr/data/15099592/fileData.do#tab-layer-openapi

Required .env values:
    DATA_GO_KR_API_KEY=...
    WESTERN_POWER_API_URL=https://api.odcloud.kr/api/...

Run from the project root:
    python -m nzk_aphiam.data.scrape.thermal.western_power
"""
...
DEFAULT_OUTPUT_DIR = PROJECT_ROOT / "data" / "raw" / "western_power"
...
def make_output_stem(out_dir: Path) -> Path:
    ...
    return out_dir / "western_power_air_pollutants_generation"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Download Korea Western Power emissions and generation data."
    )
    parser.add_argument(
        "--api-url",
        default=None,
