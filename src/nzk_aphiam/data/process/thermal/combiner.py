...
VARIABLE_LABELS = {
    ...
    "oxygen": "Oxygen concentration (unit recorded in oxygen_unit)",
    "oxygen_unit": "Oxygen concentration unit",
    "flue_gas_flow": "Flue-gas flow (unit recorded in flue_gas_flow_unit)",
    "flue_gas_flow_unit": "Flue-gas flow unit",
    "temperature_celsius": "Flue-gas temperature (degrees Celsius)",
