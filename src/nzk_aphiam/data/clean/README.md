...
This folder contains scripts that convert raw downloaded API responses into analysis-ready CSV files.
...
Raw data should not be edited manually. The cleaning scripts read from `data/raw/` and write cleaned outputs to `data/processed/`.
...
```text
data/processed/cleansys_tms/cleansys_tms_wide.csv
```
...
```text
data/processed/cleansys_tms/cleansys_tms_long.csv
```
