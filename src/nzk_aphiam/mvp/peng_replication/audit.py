...
def build_input_audit(config: dict[str, Any]) -> dict[str, Any]:
    ...
    specifications = [
        (
            ...
            "mutable team-supplied MACRO scenario handoff",
            "upstream model input",
            "selected upstream MACRO input for the named scenario bundle",
        ),
        (
            "macro_metadata",
            ...
            "checksum and contributor record for the selected MACRO handoff",
        ),
        (
            "observed_generation",
