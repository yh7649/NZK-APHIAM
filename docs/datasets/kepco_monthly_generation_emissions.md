...
- `results/tables/kepco/monthly/province/`: monthly generation, EF, and
  emissions tables by province.
- `results/tables/kepco/monthly/province_by_plant/`: province-faceted monthly
  tables by plant.
...
Readable annual PNG tables and distribution plots for the fuel x technology
handoff are generated under
`results/figures/kepco/fuel_technology_year/year=YYYY/`.
The editable handoff CSVs mirror the readable PNG table layout for all years.
The Excel workbook also includes 2021 and 2025-only sheets for MACRO coupling.

The annual fuel x technology handoff tables are externally screened in
[`docs/references/thermal/kepco_ef_external_validation.md`](../references/thermal/kepco_ef_external_validation.md).
