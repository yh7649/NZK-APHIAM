...
[`references/data_sources.csv`](references/data_sources.csv). It records the
provider, dataset, coverage, granularity, units, public page, data endpoint,
access date, and important scope limitations.
...
Crosswalk aliases and manual links are recorded under `references/crosswalk/`.
