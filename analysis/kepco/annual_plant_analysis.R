...
#
# This script mirrors the monthly thermal analysis, but for the annual plant
...
figures_dir <- results_path("figures", "annual_plant")
tables_dir <- results_path("tables", "annual_plant")
objects_dir <- results_path("objects", "annual_plant")
models_dir <- results_path("models", "annual_plant")
